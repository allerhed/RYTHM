    ...
    <div className="min-h-screen bg-dark-primary">
      ...
      <PullToRefresh onRefresh={handleRefresh}>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-dark-elevated1 rounded-lg shadow-sm border border-dark-border p-6 mb-6">
          ...
          {/* Tab Navigation */}
          <div className="bg-dark-elevated1 rounded-lg shadow-sm border border-dark-border mb-6">
