      ...
      <div className="max-w-md mx-auto px-4 py-6 space-y-6">
        ...
        <div className="space-y-4">
          {session.exercises.length === 0 ? (
            <div className="bg-dark-elevated1 rounded-lg shadow-sm border border-dark-border p-6 text-center">
            ...
            session.exercises.map((exercise, index) => (
              <div
                ...
                className="bg-dark-elevated1 rounded-lg shadow-sm border border-dark-border p-4"
              >
