        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="container mx-auto px-4 py-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-dark-elevated1 border border-dark-border rounded-lg p-4 shadow-sm">
            ...
            <div className="space-y-4">
              {loading ? (
                ...
                todaysWorkouts.map((workout: any) => (
                  <div 
                    key={workout.id}
                    className="bg-dark-elevated1 border border-dark-border rounded-lg p-4 shadow-sm"
                  >
